...
public class MapActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mFirebaseUser == null) {
            ...
            user = mFirebaseFirestore.document("Users/" + mUsername);
        }

        player_image = (ImageButton) findViewById(R.id.player_image);
        pg = (CircularProgressBar) findViewById(R.id.player_xp);
        ...
        user.addSnapshotListener(this, (documentSnapshot, e) -> {
            if (documentSnapshot.exists()) {
                PlayerFC playerFC = documentSnapshot.toObject(PlayerFC.class);
        ...
        /*mFirebaseFirestore.collection("Users").document("User1")
                .collection("Items")
                .document("Item1")
                .set(new PlayerItem())
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(getApplicationContext(), "DocumentSnapshot successfully written!",
        ...
        /*mFirebaseFirestore.collection("Users/User1/ItemsPlayer")
                .document().set(new PlayerItem("Item1", 10))
                .addOnCompleteListener(task -> Toast.makeText(getApplicationContext(), "Feito", Toast.LENGTH_SHORT))
        ...
        mGoogleMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                try {
                    ...
                    ImageView itemImage = (ImageView)findViewById(R.id.item);
                ...
                locationResult.addOnCompleteListener(this, new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()) {
                            ...
                            Marker enimie =  mGoogleMap.addMarker(new MarkerOptions()
                                    .position(mEnimieLocation)
                                    .title("Enimie")
                                    .icon(BitmapDescriptorFactory.fromBitmap(myMarker())));
                            enimie.setTag("attacker");
    ...
    public Bitmap myMarker() {
        int height = 100;
        int width = 100;
        BitmapDrawable bitmapdraw=(BitmapDrawable)getResources().getDrawable(R.drawable.bubonic_plague_doc_icon_3);
